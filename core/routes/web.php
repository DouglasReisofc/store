...
|--------------------------------------------------------------------------
*/
Route::get('cron', 'CronController@verificarPagamentos')->name('cron');
Route::get('limparlogs', 'LimparSiteController@limparLogs')->name('limparlogs');
...
Route::namespace('Gateway')->prefix('ipn')->name('ipn.')->group(function () {
    ...
    Route::post('mercado-pagocheckout', 'MercadoPagoCheckout\ProcessController@ipn')->name('MercadoPagoCheckout');
    Route::post('pic-pay', 'PicPay\ProcessController@ipn')->name('PicPay');
    Route::post('pag-seguro', 'PagSeguro\ProcessController@ipn')->name('PagSeguro');
    Route::post('open-pix', 'openpix\ProcessController@ipn')->name('openpix');
    Route::post('gerencia-net', 'Gerencianet\ProcessController@ipn')->name('Gerencianet');
    Route::post('asaas', 'Asaas\ProcessController@ipn')->name('Asaas');
    Route::get('asaas', 'Asaas\ProcessController@ipn')->name('Asaas');
    Route::post('polopag', 'Polopag\ProcessController@ipn')->name('Polopag');
    Route::get('polopag', 'Polopag\ProcessController@ipn')->name('Polopag');
...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('/executar-tarefa-de-cron', 'CronController@executarTarefaDeCron');
        Route::delete('users/delete/{id}', 'ManageUsersController@deleteUser')->name('users.delete');


        // Rotas para GiftCardController
        Route::get('giftcards', 'GiftCardController@index')->name('giftcards.index');
        Route::get('giftcards/create', 'GiftCardController@create')->name('giftcards.create');
        Route::post('giftcards', 'GiftCardController@store')->name('giftcards.store');
        Route::get('giftcards/{giftcard}/edit', 'GiftCardController@edit')->name('giftcards.edit');
        Route::put('giftcards/{giftcard}', 'GiftCardController@update')->name('giftcards.update');
        Route::delete('giftcards/{giftcard}', 'GiftCardController@destroy')->name('giftcards.destroy');
        ...
        // Novas rotas para reordenação
        Route::post('move-up/category', 'CategoryController@moveUp')->name('moveup.category');
        Route::post('move-down/category', 'CategoryController@moveDown')->name('movedown.category');
        ...
        Route::post('delete/sub/category', 'SubCategoryController@delete')->name('delete.sub.category');
        Route::post('clone/sub/category', 'SubCategoryController@clone')->name('clone.sub.category');
        
        Route::post('move-up/sub/category', 'SubCategoryController@moveUp')->name('moveup.sub.category');
        Route::post('move-down/sub/category', 'SubCategoryController@moveDown')->name('movedown.sub.category');
        ...
        Route::get('vendidos', 'CardController@vendidos')->name('card.vendidos');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::post('update-mobile', 'AuthorizationController@updateMobile')->name('send.verify.mobile');
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::post('twofactor/disable', 'UserController@disable2fa')->name('twofactor.disable');
                         ...
                         // Giftcard Routes
            Route::get('resgate', 'UserController@showRedeemGiftcardForm')->name('redeemGiftcard');
            Route::post('resgate', 'UserController@redeemGiftcard')->name('redeemGiftcard.post');
            ...
            Route::get('deposit/pagseguro', 'Gateway\PaymentController@pagseguro')->name('deposit.pagseguro');
            Route::get('deposit/confirm', 'Gateway\PaymentController@depositConfirm')->name('deposit.confirm');
            Route::get('deposit/status/{trx}', 'Gateway\PaymentController@checkPaymentStatus')->name('deposit.status');
