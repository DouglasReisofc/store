<?php if($seo): ?>
    ...
    <?php echo $__env->yieldPushContent('seo_share'); ?>
    <?php else: ?>
    ...
    <?php if(request()->routeIs('blog.details')): ?>
    <?php echo $__env->yieldPushContent('share'); ?>
    <?php else: ?>
...
<?php endif; ?>
<?php /**PATH /home/u153123621/domains/contas.club/public_html/core/resources/views/partials/seo.blade.php ENDPATH**/ ?>