    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div class="container">
                    <p id="textoaviso" class="mb-2"><?php echo app('translator')->get('PAGUE O PIX ABAIXO'); ?></p>
                    <img id="pixQRCode" src="data:image/png;base64,<?php echo e($data->data->base64); ?>" class="img-fluid mb-2" alt="QR Code" style="max-width: 80%; height: auto;">
                    <div id="pixCodeContainer" class="mb-2">
                        <p id="pixCode" class="fs-6" style="overflow-y: auto; max-height: 80px; margin-bottom: 0;"><?php echo e($data->data->pixCode); ?></p>
                    </div>
                    <div class="alert alert-info mt-2 mb-2">
                        Para pagar, utilize o código acima em seu aplicativo de banco. Você pode copiá-lo clicando no botão abaixo.
                    </div>
                    <a id="copyPixCode" class="btn btn-custom" data-pixcode="<?php echo e($data->data->pixCode); ?>"><?php echo app('translator')->get('Copiar Pix'); ?></a>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="window.location.href='<?php echo e(route('user.home')); ?>';">Ok</button>
      </div>
    </div>
  </div>
</div>
...
<script>
    ...
    function checkPaymentStatus() {
        const paymentId = '<?php echo e($data->data->paymentId); ?>';
        const checkStatus = () => {
            const url = new URL('<?php echo e(route('user.deposit.status', ['trx' => ':trxId'])); ?>'.replace(':trxId', paymentId));
            fetch(url)
...
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u153123621/domains/contas.club/public_html/core/resources/views/templates/basic/user/payment/Polopag.blade.php ENDPATH**/ ?>