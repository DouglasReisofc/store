...
class DepositController extends Controller
{
    ...
    {
        $pageTitle = 'Pagamentos Pendentes';
        $emptyMessage = 'No pending deposits.';
        $deposits = Deposit::where('status', 2)->with($this->depoRelations)->orderBy('id','desc')->paginate(getPaginate());
    ...
    {
        $pageTitle = 'Depositos Concluidos';
    ...
    public function rejected()
    {
        ...
        $deposits = Deposit::where('status', 3)->with($this->depoRelations)->orderBy('id','desc')->paginate(getPaginate());
        return view('admin.deposit.log', compact('pageTitle', 'emptyMessage', 'deposits'));
    }
