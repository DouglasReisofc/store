...
class SmsTemplateController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $emptyMessage = 'Nenhum código de acesso disponível';
    ...
    public function update(Request $request, $id)
    {
        ...
        $notify[] = ['success', $sms_template->name . ' modelo foi atualizado'];
    ...
    public function smsTemplateUpdate(Request $request)
    {
        ...
        $notify[] = ['success', 'O modelo de SMS foi atualizado'];
        return back()->withNotify($notify);
    }
    ...
    public function sendTestSMS(Request $request)
    {
        ...
        if ($general->sn == 1) {
            ...
            $message = shortCodeReplacer("{{message}}", 'Este é um SMS de teste', $message);
            $sendSms->$gateway($request->mobile,$general->sitename,$message,$general->sms_config);
        }

        $notify[] = ['success', 'Você deverá receber um SMS de teste em ' . $request->mobile . ' shortly.'];
        return back()->withNotify($notify);
    }
