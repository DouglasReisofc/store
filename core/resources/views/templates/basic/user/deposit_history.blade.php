        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="list-group">
                        <li class="list-group-item bg-trans">@lang('Amount') : <span class="withdraw-amount "></span></li>
                        <li class="list-group-item bg-trans">@lang('Charge') : <span class="withdraw-charge "></span></li>
                        <li class="list-group-item bg-trans">@lang('After Charge') : <span class="withdraw-after_charge"></span></li>
                        <li class="list-group-item bg-trans">@lang('Conversion Rate') : <span class="withdraw-rate"></span></li>
                        <li class="list-group-item bg-trans">@lang('Payable Amount') : <span class="withdraw-payable"></span></li>
                    </ul>
