                        ...
                        <div class="row">
                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-edit">
                                                ...
                                                <label for="profilePicUpload1" class="bg--success">@lang('Carregar Imagem')</label>
                                                <small class="mt-2 text-facebook">@lang('Arquivos suportados'): <b>@lang('jpeg'), @lang('jpg').</b> @lang('A imagem será redimensionada para 400x400px') </small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="tel" name="mobile" value="{{ auth()->guard('admin')->user()->mobile }}" >
                                </div>
...
@push('breadcrumb-plugins')
    <a href="{{route('admin.password')}}" class="btn btn-sm btn--primary box--shadow1 text--small" ><i class="fa fa-key"></i>@lang('Configuração de senha')</a>
@endpush
