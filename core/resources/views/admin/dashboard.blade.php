                ...
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--19 b-radius--10 box-shadow" >
                        ...
                        <div class="details">
                            ...
                            <a href="{{ route('admin.top.sold') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">
                                @lang('View All')
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--3 b-radius--10 box-shadow" >
                        ...
                        <div class="details">
                            ...
                            <a href="{{ route('admin.today.sale') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">
                                @lang('View All')
                            </a>
                        </div>
                    </div>
