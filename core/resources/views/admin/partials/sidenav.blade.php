    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.sub.category.index')}}">
                ...
                >
                    <a href="{{route('admin.card.index')}}" class="nav-link ">
                        ...
                        <span class="menu-title">@lang('Card')</span>
                    </a>
                </li>
                ...
                >
                    <a href="{{route('admin.card.vendidos')}}" class="nav-link ">
                        <i class="menu-icon las la-credit-card"></i>
                        <span class="menu-title">@lang('Contas Vendidas')</span>
                    </a>
                </li>
                ...
                >
                    <a href="{{route('admin.giftcards.index')}}" class="nav-link ">
                        <i class="menu-icon las las la-gift"></i>
                        <span class="menu-title">@lang('Giftcard')</span>
                    </a>
                </li>
